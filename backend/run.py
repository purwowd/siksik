...
def main() -> None:
    ...
    if gpu:
        ...
        # Tuning default workstation GPU (override lewat .env)
        os.environ.setdefault("SADT_WORKER_CONCURRENCY", "6")
        os.environ.setdefault("SADT_OCR_MAX_EDGE_PX", "2200")
        os.environ.setdefault("SADT_OCR_MIN_EDGE_PX", "1200")
        os.environ.setdefault("SADT_OCR_SHARPEN", "1")
        os.environ.setdefault("SADT_OCR_PARAGRAPH", "0")
        os.environ.setdefault("SADT_OCR_MAG_RATIO", "2.0")
        os.environ.setdefault("SADT_IMAGE_CAP_FULL", "5000")
        os.environ.setdefault("SADT_VIDEO_WHISPER_MAX_DURATION_S", "0")
        os.environ.setdefault("SADT_VIDEO_WHISPER_TRANSCRIBE_FIRST_S", "180")
        os.environ.setdefault("SADT_OCR_FULL_GALLERY", "1")
        os.environ.setdefault("SADT_CLIP_TOKOH_ENABLED", "1")
        print("SADT · GPU STACK ON")
        print("  Video  SafeWatch   | Image ICM-Assistant | Reason Qwen2.5-VL")
        print("  Audio  Whisper     | OCR PaddleOCR | CLIP tokoh")
