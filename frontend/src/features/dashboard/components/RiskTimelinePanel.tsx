import type { RiskTimeline } from "@/shared/api/client";
    ...
    <div className="timeline-panel">
      <div className="dash-section-head">
        <div>
          ...
          <p className="dash-section-copy">
            Jumlah indikasi dikonfirmasi analis per tahun, berdasarkan tanggal foto (bukan tanggal
            analisa).
          </p>
        </div>
      </div>
      ...
      {sessionLabel && (
        <p className="timeline-session">
          Fokus kasus: <strong>{sessionLabel}</strong>
        </p>
      )}
