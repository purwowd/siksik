...
export const ANALYSIS_SCOPE_OPTIONS = [
  {
    id: "device" as const,
    label: "HP saja",
    hint: "Disarankan. Galeri, kontak, SMS, recovery — tanpa crawl sosmed.",
  },
  {
    id: "social" as const,
    label: "Sosmed",
  ...
  },
  {
    ...
    label: "Gabungan",
    hint: "HP + sosmed. Paling lengkap, dan paling lama.",
  },
];
...
export const DEFAULT_ANALYSIS_SCOPE: AnalysisScope = "device";
